from pages.product_page import Product, ProductPage
from pages.products_page import ProductsPage


class ProductToCartFlow:
    def __init__(self, product_page: ProductPage, products_page: ProductsPage):
        self.product_page = product_page
        self.products_page = products_page

    def add_product_to_cart_and_get_product(
        self, category_button: str, product_name: str
    ) -> Product:
        """
    ...
    def add_product_to_cart(self, category_button: str, product_name: str) -> None:
        """
